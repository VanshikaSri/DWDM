...
numhid2 = 20;  -- Number of units in hidden layer; default = 200.
...
--numwords : in the input
numwords = 1; -- for unigrams
--batchsize = (#train_input)[2];
--numbatches = (#train_input)[3];

local file = '/home/vanshika/vanshu/dwdm/ark-twokenize-py/uni.txt'
...
model:add( nn.Tanh() );                       -- activation function.
